    ...
    <div class="navbar-vertical-container">
        <div class="navbar-vertical-footer-offset">
            ...
            <a class="navbar-brand" href="#" aria-label="Front">
                <img class="navbar-brand-logo" src="{{asset('assets/svg/logos/logo.svg')}}" alt="Logo" data-hs-theme-appearance="default">
                <img class="navbar-brand-logo" src="{{asset('assets/svg/logos-light/logo.svg')}}" alt="Logo" data-hs-theme-appearance="dark">
                <img class="navbar-brand-logo-mini" src="{{asset('assets/svg/logos-light/logo.svg')}}" alt="Logo" data-hs-theme-appearance="default">
                <img class="navbar-brand-logo-mini" src="{{asse('assets/svg/logos-light/logo-short.svg')}}" alt="Logo" data-hs-theme-appearance="dark">
            </a>
                ...
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle active" href="#navbarVerticalMenuDashboards" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="true" aria-controls="navbarVerticalMenuDashboards">
                            ...
                            <span class="nav-link-title">Dashbo12121ards</span>
                        </a>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Dashboafhgrd</h1>
                </div>
                <!-- End Col -->
                                ...
                                <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                                    ...
                                    <div class="hs-has-sub-menu nav-item">
                                        ...
                                        <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="authenticationMegaMenu" style="min-width: 14rem;">
                                            ...
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#welcomeMessageModal">Welcome Message</a>
                                            <a class="dropdown-item " href="#">Error 404</a>
                                            <a class="dropdown-item " href="#">Error 500</a>
                                        </div>
                                    </div>
