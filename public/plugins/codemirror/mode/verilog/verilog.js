...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "table tagged tasks this throughout time timeprecision timeunit tran tranif0 tranif1 tri tri0 tri1 triand trior " +
  ...
  */
  ...
  var blockKeywords = words(
    ...
    "primitive program property specify sequence table tasks"
  );
  ...
  return {
    ...
    token: function(stream, state) {
      ...
      if (curPunc == ctx.type || isClosingAssignment) {
        ...
        } else if (curKeyword == "tasks" && ctx && ctx.type == "statement") {
